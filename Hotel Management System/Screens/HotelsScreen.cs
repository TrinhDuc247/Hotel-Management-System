...
namespace Hotel_Management_System.Controllers
{
    public partial class HotelsScreen : Form
    {
        ...
        private void makeFile()
        {
            checkIfExist();
            createEmptyFile();
            var file = new FileInfo(@"C:\Users\ductr\Desktop\abc\Report.xlsx");
            ...
            using (ExcelPackage excel = new ExcelPackage(file))
            {
                ...
                FileInfo excelFile = new FileInfo(@"C:\Users\ductr\Desktop\abc\Report.xlsx");
        ...
        private void createEmptyFile()
        {
            ...
            wb.SaveAs(@"C:\Users\ductr\Desktop\abc\Report.xlsx");
            wb.Close();
        }

        private void checkIfExist()
        {
            FileInfo file = new FileInfo(@"C:\Users\ductr\Desktop\abc\Report.xlsx");
            if (file.Exists)
            {
