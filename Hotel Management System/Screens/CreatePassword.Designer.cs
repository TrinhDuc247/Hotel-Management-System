namespace Hotel_Management_System.Screens
{
    partial class CreatePassword
    {
        ...
        private void InitializeComponent()
        {
            ...
            "Bạn đã gặp người phối ngẫu của mình ở thành phố nào?",
            "Bạn tốt nghiệp trung học khi nào?",
            "Mẫu xe đầu tiên bạn sở hữu là gì?",
            "Thú cưng yêu thích của bạn là gì?",
            "Bạn lớn lên ở con đường nào khi còn nhỏ?",
            "Tên của nhân vật chính trong bộ phim yêu thích của bạn là gì?"});
            ...
            this.answerField.Font = new System.Drawing.Font("Segoe UI", 9.75F);
